Public Class frmBuscarPuesto
    Public gIdPuesto As String
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        Try
            SQL = "select iIdPuestoAlta ,cNombre ,cDescripcion  from PuestosAlta "
            ...
            If rwFilas Is Nothing = False Then
                For Each Fila In rwFilas
                    ...
                    item.Tag = Fila.Item("iIdPuestoAlta")
    ...
    Private Sub lsvPuestos_ItemActivate(ByVal sender As Object, ByVal e As System.EventArgs) Handles lsvPuestos.ItemActivate
        If lsvPuestos.SelectedItems.Count > 0 Then
            gIdPuesto = lsvPuestos.SelectedItems(0).Tag

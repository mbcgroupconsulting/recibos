Public Class frmPuestoAlta
    Dim SQL As String
    Dim blnNuevo As Boolean
    Dim gIdPuesto As String
    ...
    Private Sub Mostrar_DatosTipoEmpresa(ByVal IdTipoEmpresa As String)
        SQL = "select * from PuestosAlta where iIdPuestoAlta = " & gIdPuesto
    ...
    Private Sub cmdbuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdbuscar.Click
        Dim Forma As New frmBuscarPuesto
        If Forma.ShowDialog = Windows.Forms.DialogResult.OK Then
            gIdPuesto = Forma.gIdPuesto
            Mostrar_DatosTipoEmpresa(Forma.gIdPuesto)
    ...
    Private Sub cmdguardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdguardar.Click
        ...
        Try
            ...
            If blnNuevo Then
                'Insertar nuevo
                SQL = "EXEC setPuestosAltaInsertar  0,'" & txtnombre.Text & "','" & txtDescripcion.Text & "'," & gIdEmpresa
                SQL &= "," & IIf(cbostatus.SelectedIndex = 0, 1, 0)
            Else
                'Actualizar

                SQL = "EXEC setPuestosAltaActualizar  " & gIdPuesto & ",'" & txtnombre.Text & "','" & txtDescripcion.Text & "'," & gIdEmpresa
                SQL &= "," & IIf(cbostatus.SelectedIndex = 0, 1, 0)

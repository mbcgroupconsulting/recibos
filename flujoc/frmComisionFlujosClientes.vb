Public Class frmComisionFlujosClientes
    ...
    Private Sub MostrarCliente2()
        ...
        Try
            SQL = "select * from clientes where (iTipo=1 or iTipo=2 or iTipo=3 or iTipo=5) and iIdCliente NOT IN (select iIdCliente from clientes inner join ComisionClienteFlujo on iIdCliente=fkiIdCliente where tipo=1) order by nombre"
    ...
    Private Sub cmdbuscar_Click(sender As Object, e As EventArgs) Handles cmdbuscar.Click
        Dim Forma As New frmBuscarComisionClienteFlujo
    ...
    Private Sub MostrarDatos(ByVal IdProveedor As String)
        SQL = "select * from ComisionClienteFlujo where fkiIdCliente= " & IdProveedor & " and tipo=1"
    ...
    Private Sub MostrarCliente3(ByVal IdCliente As String)
        'Verificar si se tienen permisos
        Try
            SQL = "select * from clientes where  iIdCliente NOT IN (select iIdCliente from clientes inner join ComisionClienteFlujo on iIdCliente=fkiIdCliente where tipo=1) "
            SQL &= " UNION"

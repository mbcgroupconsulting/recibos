...
Public Class BanamexNomina
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "recibos.BanamexNomina.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBanamexNomina
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BanamexNomina = New BanamexNomina()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class ctmconstruccion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "recibos.ctmconstruccion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedctmconstruccion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ctmconstruccion = New ctmconstruccion()
        rpt.Site = Me.Site
        Return rpt
    End Function

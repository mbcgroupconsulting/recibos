...
Public Class ctmsolidaridad
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "recibos.ctmsolidaridad.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedctmsolidaridad
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ctmsolidaridad = New ctmsolidaridad()
        rpt.Site = Me.Site
        Return rpt
    End Function

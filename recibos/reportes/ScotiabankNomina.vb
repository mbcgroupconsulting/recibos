...
Public Class ScotiabankNomina
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "recibos.ScotiabankNomina.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedScotiabankNomina
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ScotiabankNomina = New ScotiabankNomina()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class ctmcarmenserdan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "recibos.ctmcarmenserdan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedctmcarmenserdan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ctmcarmenserdan = New ctmcarmenserdan()
        rpt.Site = Me.Site
        Return rpt
    End Function

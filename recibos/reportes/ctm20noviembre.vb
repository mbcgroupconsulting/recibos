...
Public Class ctm20noviembre
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "recibos.ctm20noviembre.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedctm20noviembre
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ctm20noviembre = New ctm20noviembre()
        rpt.Site = Me.Site
        Return rpt
    End Function

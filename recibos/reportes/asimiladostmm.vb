...
Public Class asimiladostmm
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "recibos.asimiladostmm.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedasimiladostmm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As asimiladostmm = New asimiladostmm()
        rpt.Site = Me.Site
        Return rpt
    End Function

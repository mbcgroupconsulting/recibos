Public Class frmBuscarClienteEmpresaK
    Public gIdCliente As String
    Public SoloActivo As Boolean = False
    Private Sub frmBuscarClienteEmpresaK_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub cmdBuscar_Click(sender As Object, e As EventArgs) Handles cmdBuscar.Click
        ...
        Try
            SQL = "select distinct(iIdCliente),nombre, nombrefiscal from clientes inner join IntClienteEmpresaKiosko on iIdCliente=fkiIdCliente "
    ...
    Private Sub txtbuscar_BindingContextChanged(sender As Object, e As EventArgs) Handles txtbuscar.BindingContextChanged

        ...
        Try
            ...
            If lsvLista.CheckedItems.Count > 0 Then
                ...
                For Each producto As ListViewItem In lsvLista.CheckedItems
                    ...
                    Dim diferenciainfonavit As DataRow = dsReporte.Tables("Deducciones").NewRow
                    ...
                    dsReporte.Tables("Deducciones").Rows.Add(diferenciainfonavit)

                    'ajuste infonavit

                    Dim ajusteinfonavit2 As DataRow = dsReporte.Tables("Deducciones").NewRow
                    ...
                    dsReporte.Tables("Deducciones").Rows.Add(ajusteinfonavit2)
                    ...
                    fonacot.Item("monto") = Math.Round(CDbl(IIf(Trim(producto.SubItems(38).Text) = "", 0, Trim(producto.SubItems(38).Text))), 2).ToString("######0.00")
                    ...
                    pension.Item("monto") = Math.Round(CDbl(IIf(Trim(producto.SubItems(39).Text) = "", 0, Trim(producto.SubItems(39).Text))), 2).ToString("######0.00")
                    ...
                    prestamocon.Item("monto") = Math.Round(CDbl(IIf(Trim(producto.SubItems(40).Text) = "", 0, Trim(producto.SubItems(40).Text))), 2).ToString("######0.00")

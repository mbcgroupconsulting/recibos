Public Class frmExportarAnticipoTMM
            ...
            If lsvLista.CheckedItems.Count > 0 Then
                ...
                For Each producto As ListViewItem In lsvLista.CheckedItems
                    ...
                    If rwUsuarioK Is Nothing = False Then
                        'insertamos el pago
                        'Insertar nuevo
                        SQL = "EXEC setanticipoInsertar    0," & rwUsuarioK(0)("IdUsuario").ToString() & ",'" & Date.Parse(Trim(producto.SubItems(1).Text)).ToShortDateString() & "',1,"
    ...
    Private Sub frmExportarAnticipoTMM_Load(sender As Object, e As EventArgs) Handles MyBase.Load

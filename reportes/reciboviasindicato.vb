...
Public Class reciboviasindicato
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "recibos.reciboviasindicato.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreciboviasindicato
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As reciboviasindicato = New reciboviasindicato()
        rpt.Site = Me.Site
        Return rpt
    End Function

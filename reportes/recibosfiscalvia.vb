...
Public Class recibosfiscalvia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "recibos.recibosfiscalvia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrecibosfiscalvia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As recibosfiscalvia = New recibosfiscalvia()
        rpt.Site = Me.Site
        Return rpt
    End Function

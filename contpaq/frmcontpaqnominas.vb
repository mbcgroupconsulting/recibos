...
Public Class frmcontpaqnominas
                            ...
                            For y As Integer = 0 To rwEmpleados.Length - 1
                                If (rwEmpleadosC(x)("codigoempleado").ToString() = rwEmpleados(y)("cCodigoEmpleado").ToString) Then
                                    ...
                                    If rwEmpleadosC(x)("estadoempleado").ToString() = "B" Then
                                        sql = "update empleadosC set fkiIdClienteInter = 1 where iIdEmpleadoC=" & rwEmpleados(y)("iIdEmpleadoC").ToString
                    ...
                    If rwDatosSindicato Is Nothing = False Then
                        For Each row As DataRow In dt.Rows
                            ...
                            Else
                                ...
                                fila.Item("imss") = Trim(row("I.M.S.S."))
                                fila.Item("subsidiado") = Trim(row("Subs al Empleo acreditado"))
                                fila.Item("costosocial") = Trim(row("fCosto"))
                                fila.Item("ISPT") = "0.00"
    ...
    Private Sub calcular()
        Dim sueldoord, neto, infonavit, descuento, prestamo, sindicato, primasin, totalsindicato, netopagar, primasa As Double
        Try
            For x As Integer = 0 To dtgDatos.Rows.Count - 1
                sueldoord = dtgDatos.Rows(x).Cells(6).Value
                neto = dtgDatos.Rows(x).Cells(7).Value
                infonavit = dtgDatos.Rows(x).Cells(8).Value
                descuento = dtgDatos.Rows(x).Cells(10).Value
                prestamo = dtgDatos.Rows(x).Cells(11).Value
                primasa = dtgDatos.Rows(x).Cells(9).Value
                ...
                dtgDatos.Rows(x).Cells(12).Value = Math.Round(sindicato, 2).ToString("##0.00")
                ...
                dtgDatos.Rows(x).Cells(15).Value = Math.Round(netopagar, 2).ToString("##0.00")
                ...
                If dtgDatos.Rows.Count > 0 Then
                    ...
                    For x As Integer = 0 To dtgDatos.Rows.Count - 1
                        ...
                        If dtgDatos.Rows(x).Cells(0).Value Then
                            ...
                            If CDbl(IIf(dtgDatos.Rows(x).Cells(14).Value = "", "0", dtgDatos.Rows(x).Cells(14).Value)) > 0 Then
                                Dim fila As DataRow = forma2.dsReporte.Tables("Tabla").NewRow
                                fila.Item("nombre") = Trim(dtgDatos.Rows(x).Cells(5).Value)
                                fila.Item("cantidad") = Math.Round(CDbl(dtgDatos.Rows(x).Cells(14).Value), 2)
                                fila.Item("letra") = ImprimeLetra(Math.Round(CDbl(dtgDatos.Rows(x).Cells(14).Value), 2))
        ...
        Try
            ...
            If dtgDatos.Rows.Count > 0 Then
                ...
                For x As Integer = 0 To dtgDatos.Rows.Count - 1
                    ...
                    hoja.Cell(filaExcel, 1).Value = dtgDatos.Rows(x).Cells(2).Value

                    hoja.Cell(filaExcel, 2).Value = dtgDatos.Rows(x).Cells(5).Value
                                    ...
                                    If PathArchivo <> "" Then
                                        ...
                                        For z As Integer = 0 To dtgDatos.Rows.Count - 1
                                            If dtgDatos.Rows(z).Cells(0).Value Then
                                                If chkSindicato.Checked Then
                                                    suma = suma + Double.Parse(dtgDatos.Rows(z).Cells(14).Value)
                                                Else
                                                    suma = suma + Double.Parse(dtgDatos.Rows(z).Cells(7).Value)
                                                End If
                                            End If
                                        ...
                                        For x As Integer = 0 To dtgDatos.Rows.Count - 1
                                            If dtgDatos.Rows(x).Cells(0).Value Then
                                                ...
                                                'Neto SA 
                                                If chkSindicato.Checked Then
                                                    sRenglon &= (Double.Parse(dtgDatos.Rows(x).Cells(14).Value) * 100).ToString("000000000000000000")
                                                Else
                                                    sRenglon &= (Double.Parse(dtgDatos.Rows(x).Cells(7).Value) * 100).ToString("000000000000000000")
                                                End If
                                        ...
                                        For x As Integer = 0 To dtgDatos.Rows.Count - 1
                                            If dtgDatos.Rows(x).Cells(0).Value Then
                                                ...
                                                nombre = (Long.Parse(contador)).ToString("0000000000")
                                                    ...
                                                    nombre = RemoverBasura(dtgDatos.Rows(x).Cells(5).Value)
                                                    If nombre.Length < 56 Then
                                                        For y As Integer = nombre.Length To 54
                                                            nombre &= " "
                                                        Next
                                        ...
                                        For x As Integer = 0 To dtgDatos.Rows.Count - 1
                                            If dtgDatos.Rows(x).Cells(0).Value Then
                                                ...
                                                If rwDatosCuenta Is Nothing = False Then
                                                    ...
                                                    Else
                                                        sRenglon &= (Long.Parse(IIf(dtgDatos.Rows(x).Cells(3).Value = "", "0", dtgDatos.Rows(x).Cells(3).Value))).ToString("000000000000000000")
                                                    End If
                                                End If
                                    ...
                                    If PathArchivo <> "" Then
                                        ...
                                        For x As Integer = 0 To dtgDatos.Rows.Count - 1
                                            ...
                                            If dtgDatos.Rows(x).Cells(0).Value Then
                                                ...
                                                'Neto SA 
                                                If chkSindicato.Checked Then
                                                    sRenglon &= (Double.Parse(dtgDatos.Rows(x).Cells(14).Value) * 100).ToString("00000000000000000")
                                                    suma = suma + Double.Parse(dtgDatos.Rows(x).Cells(14).Value)
                                                Else
                                                    sRenglon &= (Double.Parse(dtgDatos.Rows(x).Cells(7).Value) * 100).ToString("00000000000000000")
                                                    suma = suma + Double.Parse(dtgDatos.Rows(x).Cells(7).Value)
                                                End If
